...
class Config:
    ...
    predefined_pkl = os.path.join(
        data_root, "pdefined_anchors.pkl"
    ...
    prefix = f"cropping_{crop_loss_factor}croploss_{com_loss_factor}classifyloss"
    ...
    while os.path.exists(exp_path):
        ...
        try:
            ...
            index = 1
        exp_name = prefix + (f"_repeat{index}")
